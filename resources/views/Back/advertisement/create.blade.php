        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body container-fluid">
                    <form id="my-awesome-dropzone" method="post" action="{{ route('advertisement.store') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="exampleInputEmail1" class="form-label mb-0 this-reduire">Elan Adı <span
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="category_id" class="form-select form-select-lg mb-3 form-control"
                                    ...
                                    @foreach ($categories as $category)
                                        <option class="option-tree" disabled value="{{ $category->id }}">
                                            {{ $category->title }}
                                        </option>
                                        @if (count($category->categories) > 0)
                                            @foreach ($category->categories as $childCategory)

                                                <option @if (count($childCategory->categories) > 0) disabled @endif class="option-tree"
                                                    value="{{ $childCategory->id }}">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;{{ $childCategory->title }}
                                                </option>
                                                @if (count($childCategory->categories) > 0)
                                                    @foreach ($childCategory->categories as $childCategory)
                                                        <option class="option-tree" value="{{ $childCategory->id }}">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $childCategory->title }}
                                                        </option>
                                                    @endforeach
                                                @endif
                        ...
                        <div class="mb-3 mb-20">
                            <label for="exampleInputEmail1" class="form-label this-reduire">Məzmun <span
                                    style="color: red;font-size: 18px;bold">{{ $errors->first('desc') }}</span></label>
                            <textarea id="editor" name="desc" class="form-control mytextarea" cols="30" rows="10"
                                style="height:300px">{{ old('desc') }}</textarea>

                        </div>
                        <div class="row mb-20">
                            <div class="mb-3 col-md-6">
                                <label for="exampleInputEmail1" class="form-label mb-0 this-reduire">Qiymət <span
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <div>
                                            <input name="quality" type="checkbox" data-plugin="switchery"
                                                data-switchery="true" class="form-control" style="display: none;">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-3">
                                        <label for="delivery" class="form-label">Çatdırılma ? </label>
                                        <div>
                                            <input name="delivery" type="checkbox" data-plugin="switchery"
                                                data-switchery="true" class="form-control" style="display: none;">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <div>
                                            <input name="premium" type="checkbox" data-plugin="switchery"
                                                data-switchery="true" class="form-control" style="display: none;">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-3">
